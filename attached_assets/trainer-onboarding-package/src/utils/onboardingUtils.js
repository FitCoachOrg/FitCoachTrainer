 ...
 */
export const cleanDataForDatabase = (data) => {
  const cleaned = {};
 ...
 */
export const getSectionProgress = (formData, section) => {
 ...
 */
export const getAllSectionsProgress = (formData) => {
 ...
 */
export const getNextIncompleteField = (formData) => {
