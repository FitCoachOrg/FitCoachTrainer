...
-- This script fixes RLS policies for all tables in the database
...
-- Trainer table policies (uses email instead of client_id)
...
-- Trainer_client_web table policies (uses trainer_id)
