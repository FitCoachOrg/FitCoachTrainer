-- RLS Implementation - Disable RLS on trainer_client_web Table
-- This script disables RLS on trainer_client_web to avoid circular references
...
-- Step 5: Create client policies (simple client_id check)
...
-- Step 6: Create activity_info policies
...
-- Step 7: Create meal_info policies
...
-- Step 8: Create client_engagement_score policies
...
-- Step 9: Create schedule_preview policies
...
-- Step 10: Create schedule policies
...
-- Step 11: Create grocery_list policies
...
-- Step 12: Create workout_info policies
