-- Simple RLS Implementation - No Circular References
-- This script uses a completely different approach to avoid circular references
...
-- This approach uses a direct subquery without any JOINs to avoid circular references
...
-- This approach uses a direct subquery to get client_ids without complex JOINs
