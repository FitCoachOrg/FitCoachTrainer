-- Ultra-Simple RLS Implementation
-- This script uses the simplest possible approach to avoid all circular references
...
-- Use direct equality instead of subqueries to avoid circular references
...
-- Use direct subquery without any JOINs
